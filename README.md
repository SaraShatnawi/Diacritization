...
[![Deprecated](https://img.shields.io/badge/status-deprecated-red.svg)](https://github.com/yourusername/new-repo-name)

> This repo is **no longer maintained**.  
> Please visit the new repository for the latest working version (PyTorch code + trained models are available here):  
> 👉 **[github.com/rufaelfekadu/Diac](https://github.com/rufaelfekadu/Diac)**
